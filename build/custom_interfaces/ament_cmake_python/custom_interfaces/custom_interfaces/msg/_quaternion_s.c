...
bool custom_interfaces__msg__quaternion__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._quaternion.Quaternion", full_classname_dest, 44) == 0);
  }
  custom_interfaces__msg__Quaternion * ros_message = _ros_message;
  {  // x
...
PyObject * custom_interfaces__msg__quaternion__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._quaternion");
