...
#include "custom_interfaces/msg/detail/hardwarestatus__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::msg::Hardwarestatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::Hardwarestatus & ros_message)
{
  // Member: ledstatus
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::Hardwarestatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::Hardwarestatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::Hardwarestatus *>(
    untyped_ros_message);
...
get_message_type_support_handle<custom_interfaces::msg::Hardwarestatus>()
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Hardwarestatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, Hardwarestatus)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_Hardwarestatus__handle;
}
