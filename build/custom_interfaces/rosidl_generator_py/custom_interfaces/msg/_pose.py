...
class Metaclass_Pose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from custom_interfaces.msg import Point
            if Point.__class__._TYPE_SUPPORT is None:
                Point.__class__.__import_type_support__()

            from custom_interfaces.msg import Quaternion
...
class Pose(metaclass=Metaclass_Pose):
    ...
    _fields_and_field_types = {
        'position': 'custom_interfaces/Point',
        'orientation': 'custom_interfaces/Quaternion',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['custom_interfaces', 'msg'], 'Point'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['custom_interfaces', 'msg'], 'Quaternion'),  # noqa: E501
    )
