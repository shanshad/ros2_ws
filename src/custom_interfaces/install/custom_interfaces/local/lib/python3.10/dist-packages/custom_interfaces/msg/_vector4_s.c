...
bool custom_interfaces__msg__vector4__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._vector4.Vector4", full_classname_dest, 38) == 0);
  }
  custom_interfaces__msg__Vector4 * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of Vector4 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._vector4");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Vector4");
