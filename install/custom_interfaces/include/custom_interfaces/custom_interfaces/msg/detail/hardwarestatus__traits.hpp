...
#ifndef CUSTOM_INTERFACES__MSG__DETAIL__HARDWARESTATUS__TRAITS_HPP_
#define CUSTOM_INTERFACES__MSG__DETAIL__HARDWARESTATUS__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "ledstatus: ";
    rosidl_generator_traits::value_to_yaml(msg.ledstatus, out);
    out << ", ";
  }
...
inline void to_yaml(
  const custom_interfaces::msg::Hardwarestatus & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const custom_interfaces::msg::Hardwarestatus & msg)
{
...
#endif  // CUSTOM_INTERFACES__MSG__DETAIL__HARDWARESTATUS__TRAITS_HPP_
